...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     * Add an action to set the image of an image view. Can be called multiple times.
     */
    public BaseViewHolder setFileImageRoundBitmap(Context context, @IdRes int viewId, File file) {
        ImageView view = getView(viewId);
        Glide.with(context).load(file).apply(RequestOptions.bitmapTransform(new GlideRoundTransform())).into(view);
        return this;
    }

    public BaseViewHolder setFileImage(Context context, @IdRes int viewId, String file){
        ImageView view = getView(viewId);
        Glide.with(context).load(file).into(view);
        return this;
    }

    public BaseViewHolder setFileImageRoundBitmap(Context context, @IdRes int viewId, File file,RequestOptions requestOptions) {
        ImageView view = getView(viewId);
