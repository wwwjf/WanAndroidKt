package com.xianghe.ivy.weight.photo_select.config;
...
public class ISListConfig implements Serializable {
    ...
    public static class Builder implements Serializable {
        ...
        public Builder() {
            ...
            title = IvyApp.getInstance().getResources().getString(R.string.photo_select_image);
            titleBgColor = Color.parseColor("#3F51B5");
            titleColor = Color.WHITE;

            btnText = IvyApp.getInstance().getResources().getString(R.string.common_ensure);
            btnBgColor = Color.TRANSPARENT;
            btnTextColor = Color.WHITE;

            allImagesText = IvyApp.getInstance().getResources().getString(R.string.photo_select_all_images);
