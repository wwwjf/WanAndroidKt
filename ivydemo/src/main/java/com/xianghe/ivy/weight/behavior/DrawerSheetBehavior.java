...
package com.xianghe.ivy.weight.behavior;
 ...
 * by LuWei
 * <p>
 * 参考 {@link com.google.android.material.bottomsheet.BottomSheetBehavior} 实现的侧边BottomSheet.
 * 使用方法完全参考 {@link com.google.android.material.bottomsheet.BottomSheetBehavior}
 *
 * @param <V>
 */
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (this.peekHeightAuto) {
            if (this.peekWidthMin == 0) {
                this.peekWidthMin = parent.getResources().getDimensionPixelSize(R.dimen.design_bottom_sheet_peek_height_min);
            }
                ...
                for (int i = 0; i < childCount; ++i) {
                    ...
                    if (child != this.viewRef.get()) {
                        if (!expanded) {
                            ...
                            ViewCompat.setImportantForAccessibility(child, IMPORTANT_FOR_ACCESSIBILITY_NO_HIDE_DESCENDANTS/*4*/);
                        }
                    }
                }
