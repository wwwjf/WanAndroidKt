...
public class ZoomImageView extends AppCompatImageView
    ...
    private static final float SCALE_MID = 1.2f;
    ...
    public ZoomImageView(Context context, AttributeSet attrs) {
        ...
        mGestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                ...
                float x = e.getX();
                float y = e.getY();
                KLog.e("DoubleTap", getScale() + " , " + initScale);
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                KLog.e(TAG,"onSingleTapConfirmed");
    ...
    private void checkBorderAndCenterWhenScale() {
        ...
        KLog.e(TAG, "deltaX = " + deltaX + " , deltaY = " + deltaY);
    ...
    public void onGlobalLayout() {
        if (once) {
            ...
            if (d == null)
                return;
            KLog.e(TAG, d.getIntrinsicWidth() + " , " + d.getIntrinsicHeight());
            int width = getWidth();
            int height = getHeight();
            // 拿到图片的宽和高
            ...
            KLog.e(TAG, "initScale = " + initScale);
