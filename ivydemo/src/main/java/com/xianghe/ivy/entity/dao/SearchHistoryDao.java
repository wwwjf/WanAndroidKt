...
public class SearchHistoryDao extends AbstractDao<SearchHistory, Long> {
    ...
    public static class Properties {
        ...
        public final static Property SearchKey = new Property(2, String.class, "searchKey", false, "SEARCH_KEY");
        public final static Property SearchTimestamp = new Property(3, long.class, "searchTimestamp", false, "SEARCH_TIMESTAMP");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SEARCH_HISTORY\" (" + //
                ...
                "\"SEARCH_KEY\" TEXT," + // 2: searchKey
                "\"SEARCH_TIMESTAMP\" INTEGER NOT NULL );"); // 3: searchTimestamp
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, SearchHistory entity) {
        ...
        if (searchKey != null) {
            stmt.bindString(3, searchKey);
        }
        stmt.bindLong(4, entity.getSearchTimestamp());
    }
    ...
    public SearchHistory readEntity(Cursor cursor, int offset) {
        SearchHistory entity = new SearchHistory( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // searchKey
            cursor.getLong(offset + 3) // searchTimestamp
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, SearchHistory entity, int offset) {
        ...
        entity.setSearchKey(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setSearchTimestamp(cursor.getLong(offset + 3));
     }
