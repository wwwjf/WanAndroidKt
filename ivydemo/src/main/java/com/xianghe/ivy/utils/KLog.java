        ...
        switch (type) {
            ...
            case JSON: {
                ...
                if (jsonContent.toString().length() > 3200) {
                    Log.d(tag, "jsonContent.length = " + jsonContent.toString().length());
                    int chunkCount = jsonContent.toString().length() / 3200;
                    for (int i = 0; i <= chunkCount; i++) {
                        int max = 3200 * (i + 1);
                        if (max >= jsonContent.toString().length()) {

                            Log.d(tag, jsonContent.toString().substring(3200 * i));

                        } else {

                            Log.d(tag, jsonContent.toString().substring(3200 * i, max));
