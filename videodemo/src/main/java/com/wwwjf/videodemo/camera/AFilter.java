...
import com.wwwjf.videodemo.MyApplication;
import com.wwwjf.videodemo.utils.MatrixUtils;
import com.wwwjf.videodemo.utils.OpenGlUtils;
...
//        Log.e("videoo", "---卡主了？ 21");
    ...
    protected final void createProgramByAssetsFile(String vertex, String fragment){
        createProgram(OpenGlUtils.uRes(MyApplication.getContext(),vertex),OpenGlUtils.uRes(MyApplication.getContext(),fragment));
    }
