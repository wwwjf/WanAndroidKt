...
public class AudioEncodeRunnable implements Runnable {
    ...
    private static final String TAG = AudioEncodeRunnable.class.getSimpleName();
    private String pcmPath;
    private String audioPath;
    private AudioDecodeListener mListener;

    public AudioEncodeRunnable(String pcmPath, String audioPath, final AudioDecodeListener listener) {
        this.pcmPath = pcmPath;
        this.audioPath = audioPath;
        mListener = listener;
        Log.e(TAG, "AudioEncodeRunnable: pcmPath:"+pcmPath+",audioPath:"+audioPath);
    }
        ...
        try {
            ...
            while (!isReadEnd) {
                ...
                while (outputIndex >= 0) {
                    ...
                    AudioCodecUtil.addADTStoPacket(chunkAudio, outPacketSize);// 添加ADTS
